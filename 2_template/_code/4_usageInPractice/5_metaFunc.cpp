...
static_assert(metaFunc_forwarding::integral_constant<int, 42>::value == 42);
static_assert(std::is_same_v<
              int, metaFunc_forwarding::integral_constant<int, 0>::value_type>);
static_assert(metaFunc_forwarding::integral_constant<int, 42>{} == 42);

int main() {
    metaFunc_forwarding::integral_constant<int, 42> f;
    static_assert(f() == 42);
